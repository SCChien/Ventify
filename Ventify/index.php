...
if (isset($_POST['create_album'])) {
    ...
    if ($albumName !== 'favourite' && !isset($database[$username]['albums'][$albumName])) {
        ...
        echo "<script>alert('Album \"$albumName\" created successfully!');window.location.href = 'index.php';</script>";
    } else {
        echo "<script>alert('Cannot create album named \"favourite\" or album already exists.');window.location.href = 'index.php';</script>";
    }
}
...
if (isset($_POST['add_downloaded_song'])) {
    ...
    if ($isSongExist) {
        echo "<script>alert('Song \"$downloadedSong\" is already in the album \"$albumName\".');window.location.href = 'index.php';</script>";
    } else {
        ...
        saveDatabase($database);
        echo "<script>alert('Downloaded song \"$downloadedSong\" added to album \"$albumName\" successfully!');window.location.href = 'index.php';</script>";
    }
}
...
if (isset($_POST['delete_song'])) {
    ...
    saveDatabase($database);
    echo "<script>alert('Song \"$songToDelete\" deleted from album \"$albumName\" successfully!');window.location.href = 'index.php';</script>";
}
...
<body>
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="right-box">
                <div class="recm_list">
                    <div class="recm_word">Recommend<i class="iconfont icon-jiantou-xiangyou"></i></div>
                    <ul>
                        <li>
